 ...
 *
 * DEPRECATED: This i18n code 'kh' is deprecated and will be removed in 2.0.
 * Khmer support is now in a 'km' translation file to follow the ISO i18n
...
;(function($){
	...
	$.fn.datepicker.deprecated('The i18n code "kh" is deprecated and will be removed in 2.0. For Khmer support use "km" instead.');
}(jQuery));
